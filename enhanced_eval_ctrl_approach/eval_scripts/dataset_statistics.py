...
dataset_list, files = myutils.load_dataset(data_folder, subfolders, emas, emis, centered=False)
...
for dataset, file in zip(dataset_list, files):
    ...
    valid_ratio = myutils.get_valid_ratio(X)
...
'variance_ema_scores': variation_emas_array
}
